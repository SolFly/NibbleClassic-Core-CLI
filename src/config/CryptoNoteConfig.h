...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1682177;
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(210000000);
...
For example:
Nibbled --print-genesis-tx --genesis-block-reward-address nibv2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "011801ff000180b1916402217a4823381b4848f1982e7b7ee25f8a8ed1e2011365c697dc995ef2fc0873832101c3740c6f99a0c1832c042b114d694f1d920cdfed02b237f7544dc44f30109c4d";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in Nibbled. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1543276800;
...
/* The mixin to use by default with zedwallet and nibble-service */
...
const char     P2P_STAT_TRUSTED_PUB_KEY[]                    = "6e6962626c65636c6173736963";
